 ...
 * @author trainh
 */
@WebServlet(name = "DeleteRoomHistoryController", urlPatterns = {"/DeleteRoomHistoryController"})
public class DeleteRoomHistoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Tbl_History_DAO dao = new Tbl_History_DAO();
        ...
        try {
            ...
            dao.updateDeleteRoom(historyID);
            listHistory = dao.getListHistoryByEmail(account.getEmail());
